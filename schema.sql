...
CREATE TABLE IF NOT EXISTS students (id TEXT PRIMARY KEY, polo_id TEXT, name TEXT NOT NULL, cpf TEXT, phone TEXT, email TEXT, course TEXT, class_name TEXT, status TEXT DEFAULT 'ativo', asaas_customer_id TEXT, created_by TEXT, created_at TEXT DEFAULT CURRENT_TIMESTAMP, updated_at TEXT DEFAULT CURRENT_TIMESTAMP);
